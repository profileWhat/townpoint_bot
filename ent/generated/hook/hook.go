...
type PointFunc func(context.Context, *generated.PointMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f PointFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.PointMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.PointMutation", m)
}

// The RegionFunc type is an adapter to allow the use of ordinary
// function as Region mutator.
type RegionFunc func(context.Context, *generated.RegionMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f RegionFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.RegionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.RegionMutation", m)
}

// The TownFunc type is an adapter to allow the use of ordinary
// function as Town mutator.
type TownFunc func(context.Context, *generated.TownMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f TownFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.TownMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.TownMutation", m)
}
